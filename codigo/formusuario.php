...
<body class="corpousu">
    <div class="cartaousu">
        ...
        <form id="formusuario" action="salvarusuario.php?id=<?= $id ?>" method="post">
            ...
            <div class="mb-3"> <label for="senha" class="formusu">SENHA</label> <input type="password" class="form-control" id="senha" name="senha" placeholder="********" value="<?= $senha ?>"> </div> <a href="index.php" class="link">Ja tem conta? Entre aqui</a>
